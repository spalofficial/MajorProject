<%-- 
    Document   : dsignin
    Created on : Apr 17, 2018, 9:16:30 AM
    Author     : Souvik Pal
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-lg-9">                
                <form class="form-horizontal" action="dsignin" method="post">
                    <fieldset>
                        <legend> Doctor Sign In </legend>
                        <div class="form-group">
                            <label class="col-md-4 control-label">Doctor Id</label>
                                <div class="col-md-6  inputGroupContainer">
                                    <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input name="userid" placeholder="Doctor Id" class="form-control" type="text">
                                    </div>
                                </div>
                        </div>
                        <div class="form-group">
