<%-- 
    Document   : dlist
    Created on : Apr 18, 2018, 10:50:40 AM
    Author     : Souvik Pal
--%>
                    ...
                    <%
                        ...
                        if(session.getAttribute("userid")==null){
                            ...
                            try{
                                ...
                                out.println("<table border=2><tr><td><b>DOCTOR ID</b></td><td><b>FIRST NAME</b></td><td><b>LAST NAME</b></td><td><b>PHONE NUMBER</b></td><td><b>GENDER</b></td><td><b>DEPARTMENT</b></td><td><b>DEGREE</b></td><td><b>CLINIC CITY</b></td><td><b>FEES</b></td><td><b>EMAIL</b></td><td><b>V STATUS</b></td><td><b>ACTION</b></td></tr>");
                                while(rs.next()){
                                    out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(9)+"</td><td>"+rs.getString(10)+"</td><td>"+rs.getString(14)+"</td><td><a href=a?id="+rs.getString(1)+"&type=doctor&action=delete&list=dlist>DELETE</a></td></tr>");
                                    x++;     
                                }
                                out.println("</table>");
                                if(x==0){
