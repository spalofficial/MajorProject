<%-- 
    Document   : afeedback
    Created on : Apr 18, 2018, 10:18:34 AM
    Author     : Souvik Pal
--%>
                ...
                <div class="col-md-12">
                    ...
                    <%
                        ...
                        if(session.getAttribute("userid")==null){
                            ...
                            try{
                                int x=0;
                                String query="select * from feedback where usertype='doctor'";
                                Class.forName("oracle.jdbc.driver.OracleDriver");
                                Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","n1","p1");
                                Statement st=con.createStatement();
                                ResultSet rs=st.executeQuery(query);
                                out.println("<table border=2><tr><td><b>USER TYPE</b></td><td><b>ID</b></td><td><b>DATE</b></td><td><b>ISSUE</b></td></tr>");
                                while(rs.next()){
