                ...
                <div class="col-md-12">
                    ...
                    <%
                        ...
                        if(session.getAttribute("userid")==null){
                            ...
                            try{
                                int x=0;
                                String query="select * from commission where doctorid='"+session.getAttribute("userid")+"' and adminpay='pending'";
                                Class.forName("oracle.jdbc.driver.OracleDriver");
                                Connection con= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","n1","p1");
                                Statement st=con.createStatement();
                                ResultSet rs=st.executeQuery(query);
                                out.println("<table border=2><tr><td><b>APOINTMENT ID</b></td><td><b>DOCTOR ID</b></td><td><b>AMOUNT</b></td><td><b>PAYMENT STATUS</b></td><td><b>ACTION</b></td></tr>");
                                while(rs.next()){
                                    out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td><a href=dpay.jsp?aid="+rs.getString(1)+"&did="+rs.getString(2)+"&amount="+rs.getString(3)+">PAY</a></td></tr>");
                                    x++;     
                                }
                                out.println("</table>");
                                if(x==0){
