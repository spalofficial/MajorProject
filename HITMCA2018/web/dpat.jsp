                ...
                <%
                  if(session.getAttribute("userid")!=null){
                      ...
                      try{
                            ...
                            out.println("<table border=2><tr><td><b>ID</b></td><td><b>APPOINTMENT ID</b></td><td><b>USER ID</b></td><td><b>DOCTOR ID</b></td><td><b>APPOINTMENT STATUS</b></td><td><b>APPOINTMENT DATE</b></td><td><b>DOCTOR VISIT STATUS</b></td><td><b>PAYMENT STATUS</b></td><td><b>ACTION</b></td><td><b>ACTION</b></td><td><b>ACTION</b></td><td><b>ACTION</b></td></tr>");
                            while(rs.next()){
                                out.println("<tr><td>"+rs.getString(1)+"</td><td>"+did+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td><td><a href=Action?id="+rs.getString(1)+"&action=adate>SET DATE</a></td><td><a href=Action?id="+rs.getString(1)+"&action=dvisit>DOCTOR VISIT STATUS CHANGE</a></td><td><a href=Action?id="+rs.getString(1)+"&action=pstatus>CHANGE PAYMENT STATUS</a></td><td><a href=Action?id="+rs.getString(1)+"&action=cancel>CANCEL</a></td></tr>");
                                x++;     
                            }
                                out.println("</table>");
                            if(x==0){
