<%-- 
    Document   : asignin
    Created on : Apr 17, 2018, 11:40:37 AM
    Author     : Souvik Pal
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-lg-9">                
                <form class="form-horizontal" action="asignin" method="post">
                    <fieldset>
                            ...
                            <label class="col-md-4 control-label">Admin Id</label>
                                <div class="col-md-6  inputGroupContainer">
                                    <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                        <input name="userid" placeholder="Admin Id" class="form-control" type="text">
                                    </div>
                                </div>
                        </div>
                        <div class="form-group">
