<%-- 
    Document   : uappoint
    Created on : Apr 17, 2018, 11:47:29 PM
    Author     : Souvik Pal
--%>
...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h1><%out.println("APPOINTMENT DETAILS");%></h1><br>
                    <pre><h3>
                    <%
                        ...
                        try{
                            ...
                            String query="select * from appointment where userid='"+u+"'";
                            ResultSet rs=st.executeQuery(query);
                            out.println("<table border=2><tr><td><b>APPOINTMENT ID</b></td><td><b>USER ID</b></td><td><b>DOCTOR ID</b></td><td><b>APPLICATION STATUS</b></td><td><b>APPLICATION DATE</b></td><td><b>DOCTOR VISIT STATUS</b></td><td><b>PAYMENT STATUS</b></td><td><b>ACTION</b></td></tr>");
                            while(rs.next()){
                                out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td><td><a href=deleteapp?appid="+rs.getString(1)+">DELETE</a></td></tr>");
                                x++;     
                            }
                                out.println("</table>");
                            if(x==0){
